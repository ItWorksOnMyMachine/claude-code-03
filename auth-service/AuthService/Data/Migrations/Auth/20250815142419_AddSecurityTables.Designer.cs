...
namespace AuthService.Data.Migrations.Auth
{
    ...
    [Migration("20250815142419_AddSecurityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthService.Data.Entities.AuthenticationAuditLog", b =>
                {
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("IX_AuthenticationAuditLogs_TenantId");
                    ...
                    b.HasIndex("TenantId", "UserId", "Timestamp")
                        .HasDatabaseName("IX_AuthenticationAuditLogs_Tenant_User_Timestamp");
            ...
            modelBuilder.Entity("AuthService.Data.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("ProhibitedPasswordPatterns")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("RequireUniqueChars")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AuthService.Data.Entities.TenantRole", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("AuthService.Data.Entities.TenantRole", null)
                        .WithMany()
