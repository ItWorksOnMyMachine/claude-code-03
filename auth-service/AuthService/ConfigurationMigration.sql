...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250815122631_InitialIdentityServerConfigurationSchema') THEN
...
BEGIN
    ...
    VALUES ('20250815122631_InitialIdentityServerConfigurationSchema', '9.0.0');
    END IF;
END $EF$;
COMMIT;
