 ...
 * Provides event-based messaging between platform host and remote modules
 */
...
export class ModuleCommunication {
  ...
  static getInstance(moduleId: string = 'platform_host'): ModuleCommunication {
   ...
   */
  subscribeAll(handler: ModuleMessageHandler): () => void {
